...
#ifndef SALESMATECHATSDK_SWIFT_H
#define SALESMATECHATSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SalesmateChatSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16SalesmateChatSDK13SalesmateChat")
@interface SalesmateChat : NSObject
+ (void)setSalesmateChatWithConfiguration:(Configuration * _Nonnull)settings;
